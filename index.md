...
## What People Are Forced to Do Just to Tinker

In their sheer will to take back control, enthusiasts have been pushed to extreme measures:

- Xiaomi users have resorted to [**physically grabbing their phones from service centers**](https://www.reddit.com/r/PocoPhones/comments/1mak843/xiaomi_users_escape_service_centers_with/) during downgrade procedures, hoping to exploit a fleeting window to unlock their devices.
- A UK Zenfone buyer [**sued ASUS**](https://xdaforums.com/t/court-action-against-asus-false-promise-on-bootloader-unlock-tool.4657042/) after the company broke its promise to provide bootloader unlocking tools. The buyer won — receiving a full refund of £770. ASUS had promised these tools, then disabled them, and even removed discussions about bootloader unlocking from its forums.

It is a tragedy that people have to go to such lengths merely to tinker with something they lawfully own.

But here is the crucial point: **the OEM lockdown does not only affect “geeks.” It poses a major threat to security, privacy, and consumer rights for *every single smartphone user*.**
...
*This is a living document. As the movement grows, as new evidence emerges, and as the landscape evolves, these demands and strategies will be refined. The goal is not to produce a perfect document — the goal is to start a movement.*